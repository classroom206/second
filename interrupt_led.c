...
void EINT0_IRQHandler(void)
{
    ...
    LPC_GPIO2->FIOPIN ^= (1 << LED1);  /* Toggle LED1 every time INTR0 is generated */
}

void EINT1_IRQHandler(void)
{
    LPC_SC->EXTINT = (1 << SBIT_EINT1); /* Clear Interrupt Flag */
    LPC_GPIO2->FIOPIN ^= (1 << LED2);  /* Toggle LED2 every time INTR1 is generated */
}
...
int main()
{
    ...
    LPC_SC->EXTPOLAR = (1 << SBIT_EXTPOLAR0) | (1 << SBIT_EXTPOLAR1); /* Configure EINTx as Falling Edge */
